...
import br.com.codenation.Util.ComparadorDesempateReverso;
...
public class DesafioMeuTimeApplication implements MeuTimeInterface {
  ...
  public String buscarCorCamisaTimeDeFora(Long timeDaCasa, Long timeDeFora) {
    ...
    if (casa.getCorUniformePrincipal().equals(corTimeDeFora)) {
      corTimeDeFora = fora.getCorUniformeSecundario();
    }
